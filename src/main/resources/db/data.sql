insert into user_tb(username, password, email, created_at) values('ssar', '$2a$10$ezAaHqUqtUAng.zxZGWsNe', 'ssar@nate.com', now());
insert into user_tb(username, password, email, created_at) values('cos', '$2a$10$ezAaHqUqtUAng.zxZGWsNe', 'cos@nate.com', now());
...
insert into board_tb(title, content, user_id, created_at) values ('title10', '내용10', 2, now());
insert into board_tb(title, content, user_id, created_at) values ('title11', '내용11', 2, now());
